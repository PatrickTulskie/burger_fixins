...
describe 'burger_fixins' do
  ...
  before(:all) do
    class TestSettings
      ...
      setting :bacon, :type => :boolean
      setting :lettuce_types, :type => :array
      setting :burger_limit, :type => :integer, :initial => 5
  ...
  it "should have an initial value" do
    TestSettings.burger_limit.should == 5
  end
